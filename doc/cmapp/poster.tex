        ...
        \begin{columns}[t]
            ...
            \begin{column}{\onecolwid} % Start of column 2
                ...
                \begin{block}{Flight}
                    ...
                    Flight is our implementation of a VR UI library and the DIM
                    architecture. Flight is designed from the ground up to be
                    performant, general, and modular.

                    Flight provides high level abstractions for interacting with
                    VR hardware, rendering objects in VR, and resolving
