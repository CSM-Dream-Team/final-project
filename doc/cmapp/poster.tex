...
\title{Exploration of Virtual Reality Using Deferred Immediate Mode}
    ...
    \begin{frame}[t] % The whole poster is enclosed in one beamer frame
        ...
        \begin{columns}[t]
            ...
            \begin{column}{\onecolwid} % The first column
                ...
                \begin{block}{Deferred Immediate Mode (DIM)}

                    \textbf{Immediate Mode} is an architecture in which the
                    entire UI is defined procedurally every frame. However,
                    there is a problem with immediate mode:
                    ...
                    To solve this incomplete information problem, we added a new
                    aspect to immediate mode: \textbf{deferability}. This
                    provides a number of benefits.

                    \begin{itemize}

                        \item \textbf{Procedural UI Generation:} like immediate
                            mode, DIM allows for easy procedural definition of
                            UIs.

                        \item \textbf{Prevents Stale State and Cross Mutation:}
                            stale state occurs when the UI continues to display
                            old data even after an update to the data. Cross
                            mutation occurs when one UI element can modify the
                            state of another element. Since the entire UI is
                            recalculated every frame, there is no possibility
                            for these problems.

                        \item \textbf{Interdependency Resolution:}
                            interdependencies are resolved after all elements
                            have reported their state.
            ...
            \begin{column}{\onecolwid} % Start of column 2
                ...
                \begin{block}{Flight}
                    ...
                    Through the exploration of existing VR frameworks, we
                    determined that none of them achieved our goals for VR
                    development.

                    This led us to create Flight, our own VR toolkit featuring
                    high level abstractions for interacting with VR hardware,
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.85\linewidth]{../report/screenshots/physics_b.jpg}
                    \caption{Our Final Project}
                    \label{fig:project}
                \end{figure}
