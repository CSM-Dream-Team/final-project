...
writing the software. The desktop, mobile, and web application fields already
have general purpose user interface toolkits. The virtual reality field needs
the same.

% TODO: integrate this in somehow
General, not opinionated, not bloated % <- maybe make these+Modular the sections?
In other words, an architecture must not be opinionated about which types of
application should be created with it.

% TODO: something about why WE need this
...
don't care if you integrate a ton of things, just don't want them to get in the
way, be compartmentalized


Many current VR architectures have features such as pathfinding and
...
\subsection{Programmable}% integrate this above
