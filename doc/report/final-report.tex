...
both immediate mode and retained mode. It uses immediate mode as a base and thus
inherits the easy procedural definition of UIs. Additionally, DIM does not have
the problem of stale state and cross mutation. DIM solves the incomplete data
problem by providing synchronization using deferability.
